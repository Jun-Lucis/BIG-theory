# Limitations and Scope of Boundary Information Geometry (BIG)

This document summarizes the intended scope and limitations of **Boundary Information Geometry (BIG)**.

BIG is a developing boundary-centered research programme. It is not presented as a completed physical theory or as a quantitatively calibrated model of any specific physical, biological, cognitive, or technological system.

---

## 1. General status

BIG should currently be understood as a collection of:
...
These layers do not have the same evidential status.

A numerical result in a reduced model should not be read as a direct prediction about a real physical system unless the relevant domain-specific equations, parameters, units, calibration, and validation have been added.

---

## 2. What BIG currently claims

The current BIG programme supports limited, model-level claims such as:

* boundary layers can behave as active structures rather than passive edges;
* local boundary profiles can exhibit robust quadratic-like landing in certain reduced PDE models;
...
## 3. What BIG does not currently claim

BIG does **not** currently claim to be:

* a completed theory of fundamental physics;
* a replacement for general relativity, quantum mechanics, quantum field theory, nuclear physics, or statistical mechanics;
* a quantitative model of nuclear fission;
* a quantitative model of nuclear fusion;
...
BIG-B9 studies a minimal energy competition,
...
## 7A. B13--B15 scope: observation, history, and representation

B13 and B13.1 use reduced observation-like state-selection models and compare some angular selection statistics with Born-like reference structure. They do not derive quantum measurement, the Born rule, uncertainty relations, consciousness, or AI perception.

B14 introduces explicit boundary-history operators for writing, relaxation, fusion, division, and lineage propagation. These operators are not quantitative models of genetics, fertilization, biological heredity, or cell division.

B15 uses Hilbert-like and density-like representations to organize hidden-depth states and boundary history. This notation is representational and does not establish physical quantum channels or a quantum theory of BIG.

---

## 7B. B16--B18 scope: memory-bearing boundaries and readout

B16--B18 study reduced history-bearing moving boundaries and propagating fronts.
...
stored history
    ...
    -> path-readable / interface-core exposure
    -> later response
```

A retained history field is therefore not automatically a response variable. Its dynamical effect depends on the adopted boundary-dependent readout.

These models are not calibrated theories of biological, neural, chemical, or material memory.

---

## 7C. B19--B20 scope: synthetic vorticity and response geometry

B19 and B20 use finite synthetic divergence-free three-dimensional vorticity families and finite observation windows.
...
B20 defines a finite-time response function
...
This response boundary is a parameter-space object generated by the finite-time evolution operator and readout. It is not automatically a physical-space boundary, invariant manifold, asymptotic separatrix, or universal threshold.

B20.5's reconstructed response-boundary normal is restricted to the tested normalized four-dimensional subspace. Finite-difference agreement and prospective directional-derivative agreement do not prove continuum differentiability or extend the result to the full parameter space.

Neither B19 nor B20 proves Navier--Stokes blow-up, regularity, or singularity formation.
...
* finite-amplitude thresholds,
* anisotropy,
* separation,
* capture,
* memory retention,
* non-assimilative interaction,
...
> Boundary Information Geometry is a boundary-centered research programme exploring how individuality, stability, separation, capture, and inheritance may arise in reduced mathematical and numerical models. Its current results are structural and model-level, not calibrated physical predictions.

For B9:

> BIG-B9 provides a structural comparison with fission-like metastability, not a quantitative nuclear-fission model.

For B10:

> BIG-B10 studies stochastic-resonance-like finite-noise capture in a reduced dynamic boundary model, not physical nuclear fusion.

For B11:

> BIG-B11 studies non-assimilative hidden-depth inheritance in a stochastic reduced model, not biological inheritance or real energy release.
